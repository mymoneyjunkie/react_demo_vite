										...
										{homeData.featured && homeData.featured.map(i => (
											<Link to={`/video/${i.id}?title=${i.title.slice(0, 5)}`} key={i.id} className="h-70 relative dark:shadow-md rounded-lg dark:shadow-white">
										      ...
										      <div className="absolute inset-0 flex items-center justify-center cursor-pointer">
											      	<div className="bg-stone-500 p-4 flex justify-center items-center rounded-full">
											      		<FaPlay fontSize={20} color="#000" />
											      	</div>
											  	</div>
											  	...
											  	<div className="absolute bottom-2 right-2 cursor-pointer">
											      	<div className="bg-stone-500 p-4 flex justify-center items-center rounded-full">
											     		<FaVolumeMute fontSize={20} color="#000" />
											     	</div>
											  	</div>
										  </Link>
										))}
													  ...
													  {[...Array(4)].map((_, index) => (
													    ...
													    <div className="flex items-center justify-between">
													      <p></p>
														    ...
														    <a href="#" className="uppercase text-base font-bold text-[#ee3483] hover:text-gray-500">show all</a>
														  </div>
